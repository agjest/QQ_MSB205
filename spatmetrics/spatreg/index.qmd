...
::: incremental
A.  Local versus global spillover
...
B.  Only two model specifications relevant for applied work
    i.  SDEM
...
::: incremental
C.  Estimation procedures, not only point estimates
    i.  Estimates of dispersion

    ii. Calculate direct/indirect effects
D.  "Avoid the temptation for observation-level inference"
E.  "Keep the weight matrix simple"
:::
