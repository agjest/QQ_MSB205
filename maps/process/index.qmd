...
-   Use an R markdown notebook to document the data wrangling and make
    it reproducible. Place this R Notebook in your Data directory.
...
-   Important to get the dataset finished (as far as possible). Will
    save us huge amounts of time and work.
...
-   Use a new Rmarkdown notebook to document the preparations done to
    your map and the merging of data to the map.
...
-   Generate the weights matrix in R (import to GeoDa) or make it in
    GeoDa
