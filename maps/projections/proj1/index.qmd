...
-   Shows the position of Haugesund on the globe, in degrees, minutes
    and seconds
...
-   The second degree is **longitude**, east (E) from the zero meridian
    (through Greenwich, just east of London).
...
.pull-left-40\[ - T and O maps - Jerusalem center, Asia up, Europe lower
left, Africa lower right - Hereford mappa mundi, ca. 1300 (from
wikipedi.org)\]

## .pull-right-60\[ .center\[ ![Hereford mappa mundi](mappa_mundi.png)\]\]

## Haugesund

.pull-left-40\[ - Haugesund (wikipedia.org): 59°24′37″N 5°16′32″Ø\]
.pull-right-60\[\]
...
Simple features standard did not exist when **sp** was designed.
