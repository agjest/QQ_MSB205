...
-   if we insist to be authority_compliant, we will use latitude value
    for longitude
...
al.)](test_insertimage_1.png){alt="Simple feature (fig. 2.2 Lovelace et. al.)"}

## Introduction

-   Maps and some projections

-   Geographical coordinates (latitude, longitude *or* longitude,
    latitude)
...
-   4 (3) types of distortion
    ...
    -   4\. Direction (No map has true direction everywhere.)
...
-   Example gapminder, we will use newgapminder our updated version of
    the dataset from last assignment
